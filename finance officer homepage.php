        ...
        <div class="row">
            <div class="centercolumn">
                <div class="card">
                    ...
                    <h1>Finance Officer Homepage</h1>
                            ...
                            <tr>
                                <td style="width:50%">
                                    <form method="post">
                                        ...
                                        <a href="update finance officer profile.php" class="button" ><b>Update Finance Officer Profile</b></a>
                                </td>
                                <td>
                                        <label for="main">Employee ID</label>
                                        <input type="text" id="main" name="main" value="<?php echo $user_data['user_id']; ?>">
                                        <a href="view login history.php" class="button" ><b>View Login History</b></a>
                                    </form>
                                </td>
                            </tr>
                        </table>
