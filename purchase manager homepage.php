        ...
        <div class="row">
            <div class="centercolumn">
                <div class="card">
                    ...
                    <h1>Purchase Manager Homepage</h1>
                            ...
                            <tr>
                                <td style="width:50%">
                                    <form method="post">
                                        ...
                                        <a href="update purchase manager profile.php" class="button" ><b>Update Purchase Manager Profile</b></a>
                                </td>
                                <td>
                                        <label for="main">Employee ID</label>
                                        <input type="text" id="main" name="main" value="<?php echo $user_data['user_id']; ?>">
                                        <a href="view purchase manager profile.php" class="button" ><b>View Profile</b></a>
                                    </form>
                                </td>
                            </tr>
                        </table>
