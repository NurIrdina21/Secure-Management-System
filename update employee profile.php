...
if(isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE employee SET surname='$newEmployeeName', user_id='$newEmployeeID', IC='$newIC' , confirmpass='$newconfirmpass' WHERE user_id=" . $_SESSION['user_id'];
            ...
            <div class="card">
                <div class="fakeimg responsive" style="height:650px;">
                    ...
                    <form method="post">
                        ...
                        <a href="employee homepage.php" class="button" style="width:50%;"><b>Back</b></a>
