                    ...
                    <input type="hidden" name="id" value="<?php echo $user_data['id']; ?>" />
                        <table>
                            <tr>
                                <td style="width:50%">
                                    <form method="post">
                                        <label for="design">Manager Name</label>
                                        <input type="text" id="design" name="design" value="<?php echo $user_data['surname']; ?>">
                                        <a href="update manager profile.php" class="button" ><b>Update Manager Profile</b></a>
                                </td>
                                <td>
                                        <label for="main">Employee ID</label>
                                        <input type="text" id="main" name="main" value="<?php echo $user_data['user_id']; ?>">
                                        <a href="view manager profile.php" class="button" ><b>View Manager Profile</b></a>
                                    </form>
                                </td>
                            </tr>
                        </table>
